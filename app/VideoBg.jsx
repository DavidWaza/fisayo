      ...
      <section className="showcase">
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="w-full">
            <h1 className=" text-2xl text-white uppercase dosis tracking-widest text-center">
              Without #FODaADU, i&apos;m
            </h1>
            <p className="uppercase text-[114px] w-full din font-bold text-[#B5AB99]">
              Fisayo Fosudo
            </p>
            <p className="text-white uppercase text-[2rem] w-full mb-5 din-light tracking-wider">
